    ...
    <div className="bg-black text-white py-20 mx-auto ">
      <div className="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
        <div className="flex flex-col w-full lg:w-1/3 justify-center items-start p-8">
          <h1 className="text-3xl md:text-5xl py-3 text-teal-200 tracking-loose">
            Life Optimizer
          </h1>
          ...
          <a
            href="#"
            className="bg-transparent hover:bg-teal-300 text-teal-200 hover:text-black rounded shadow hover:shadow-lg py-2 px-4 border border-teal-300 hover:border-transparent"
          >
            Explore Now
          </a>
        </div>
